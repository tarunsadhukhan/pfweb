  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>MOnthly ESI Data Generation</strong></h3>
...
//start save
        $("#genpfdata").click(function(event){
          ...
          $("#genpfdata").attr('disabled',true);
          $.ajax({
           url: "<?php echo base_url('admin/esidetails/Esi_data_generation/gen_monthesidata'); ?>",
            type: "POST",
      ...
      $("#cancelpfdata").click(function(event){
          ...
          $("#cancelpfdata").attr('disabled',true);
          $.ajax({
           url: "<?php echo base_url('admin/esidetails/Esi_data_generation/cancel_monthesidata'); ?>",
            type: "POST",
                data: {pfgendate: spgdailyDate,companyId: companyId
            },
            dataType: "json",
...
//jQuery('.dataTable').wrap('<div class="dataTables_scroll" />');
            table = $('#spgdailyrecordTable').DataTable({
                ajax: {
                    url: '<?php echo base_url('admin/esidetails/Esi_data_generation/get_esigendata'); ?>',
                    type: 'POST',
                    data: function(d) {
        ...
        $('#spgdailyrecordTable tbody').on('click', 'tr', function() {
            ...
            $('#spgdailyDate').on('change', function() {
             ...
             var companyId=$('#companyId').val();
          $.ajax({
            url: "<?php echo base_url('admin/esidetails/Esi_data_generation/get_esidataexists'); ?>",
            type: "POST",
...
//	alert ("aaaa");
	var opt=3;
            ...
            var companyId=$('#companyId').val();
            var url = '<?php echo site_url("admin/esidetails/Esi_data_generation/gen_excelesidata"); ?>' +
