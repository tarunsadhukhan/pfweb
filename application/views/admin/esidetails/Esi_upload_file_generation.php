  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>MOnthly ESI Upload Data Generation</strong></h3>
    ...
    <div class="content">
      ...
      <div class="form-row">
                        ...
                        <div class="form-group col-md-1" style="margin-left: 30px;">
						    <label for="purchaseDetailsPurchaseDate">Generate ESI Data<span class="text-center"></span></label>
                        ...
                        <div class="form-group col-md-1" style="margin-left: 30px;">
						    <label for="purchaseDetailsPurchaseDate">Create online File<span class="text-center"></span></label>
                            <button name="submit" id="genpfexldata" style="height: 50px;" type="submit" class="form-control btn btn-primary">Create Xl</button>
                        </div>
...
<input type="hidden" class="input" value="<?php echo $company_id; ?>" id="companyId" />
            ...
            <h1>Monthly ESI Generated Data</h1>
...
//start save
        $("#genpfdata").click(function(event){
          ...
          $("#genpfdata").attr('disabled',true);
          $.ajax({
           url: "<?php echo base_url('admin/esidetails/Esi_upload_file_generation/gen_monthesidata'); ?>",
            type: "POST",
      ...
      $("#cancelpfdata").click(function(event){
          ...
          $("#cancelpfdata").attr('disabled',true);
          $.ajax({
           url: "<?php echo base_url('admin/esidetails/Esi_upload_file_generation/cancel_monthesidata'); ?>",
            type: "POST",
                data: {pfgendate: spgdailyDate,companyId: companyId
            },
            dataType: "json",
...
//jQuery('.dataTable').wrap('<div class="dataTables_scroll" />');
            table = $('#spgdailyrecordTable').DataTable({
                ajax: {
                    url: '<?php echo base_url('admin/esidetails/Esi_upload_file_generation/get_esigendata'); ?>',
                    type: 'POST',
                    data: function(d) {
        ...
        $('#spgdailyrecordTable tbody').on('click', 'tr', function() {
            ...
            $('#spgdailyDate').on('change', function() {
             ...
             alert('aa');
          $.ajax({
            url: "<?php echo base_url('admin/esidetails/Esi_upload_file_generation/get_esidataexists'); ?>",
            type: "POST",
...
//	alert ("aaaa");
	var opt=3;
            ...
            var companyId=$('#companyId').val();
            var url = '<?php echo site_url("admin/esidetails/Esi_upload_file_generation/gen_excelesidata"); ?>' +
