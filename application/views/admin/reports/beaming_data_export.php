  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;">Beaming Data Export</h3>
    ...
    <div class="content">
      ...
      <div class="form-row">
			  ...
			  <label for="purchaseDetailsPurchaseDate">Export Beaming Data<span class="text-center"></span></label>
...
$("#exportdbfdata").click(function(event){
  event.preventDefault(); 
	...
	var opt=3;
            ...
            var url = '<?php echo site_url("admin/reports/beaming_data_export/exportdbfdata"); ?>' +
