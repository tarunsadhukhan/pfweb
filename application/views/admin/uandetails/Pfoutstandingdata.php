  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>PF MOnthwise Outstanding Details</strong></h3>
    ...
    <div class="content">
      ...
      <div class="form-row">
            ...
            <div class="form-group col-md-2" style="margin-left: 30px;">
						    <label for="purchaseDetailsPurchaseDate">Excel File<span class="text-center"></span></label>
  ...
  refreshDataTable();
        ...
        function initDatedata() {
            ...
            table = $('#spgdailyrecordTable').DataTable({
                autoWidth: true,
                                ajax: {
                    url: "<?php echo base_url('admin/uandetails/Pfoutstandingdata/Pfoutstandingdata'); ?>",
                    type: 'POST',
                    data: function(d) {
...
//            var companyId=$('#companyId').val();
            var companyId=$('#companyId').val();
             var upfromdate= $('#upfromdate').val();
             var uptodate= $('#uptodate').val();
            var url = '<?php echo site_url("admin/uandetails/Pfoutstandingdata/gen_excelpfdata"); ?>' +
