  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h3 class="m-1 text-dark text-center" style="background-color: #1589FF;"><strong>Individual PF Ledger Summary</strong></h3>
    ...
    <div class="content">
      ...
      <div class="form-row">
                        ...
                        <div class="form-group col-md-1" style="margin-left: 30px;">
						    <label for="purchaseDetailsPurchaseDate">Show Details<span class="text-center"></span></label>
...
//             alert(uanid);
            table = $('#spgdailyrecordTable').DataTable({
                autoWidth: true,
                    ajax: {
                    url: "<?php echo base_url('admin/uandetails/Pfindividualsummary/Pfindividualata'); ?>",
                    type: 'POST',
                    data: function(d) {
...
//            var companyId=$('#companyId').val();
             ...
             var uanid=$('#record_id').val();
             var uanno=$('#uanno').val();
            var url = '<?php echo site_url("admin/uandetails/Pfindividualsummary/gen_excelpfdata"); ?>' +
